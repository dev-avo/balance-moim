        ...
        <div class="flex min-h-[calc(100vh-4rem)] items-center justify-center">
            <div class="glass border-2 border-border rounded-2xl p-6 shadow-apple-lg max-w-xl w-full mx-4">
                <div class="space-y-6">
                    ...
                    <button id="start-game-btn" class="w-full px-8 py-6 text-lg font-semibold rounded-xl bg-primary text-primary-foreground shadow-apple-lg hover:bg-primary/80 hover:shadow-apple-lg hover:scale-[1.02] active:scale-[0.98] smooth-transition transition-all duration-200">
                        시작하기
                    </button>
    ...
    mainEl.innerHTML = `
        <div class="flex min-h-[calc(100vh-4rem)] items-center justify-center py-12">
            <div class="text-center space-y-4">
                ...
                <button id="retry-btn" class="px-6 py-3 text-sm font-semibold rounded-xl bg-primary text-primary-foreground shadow-apple hover:bg-primary/80 hover:shadow-apple-lg hover:scale-[1.02] active:scale-[0.98] smooth-transition transition-all duration-200">
                    다시 시도
                </button>
            </div>
        </div>
